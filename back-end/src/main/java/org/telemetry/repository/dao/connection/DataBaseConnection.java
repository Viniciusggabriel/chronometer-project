...
public class DataBaseConnection implements DatabaseConnectionFactory {
    ...
    public Connection getConnection() throws SQLException {
        try {
            ...
            throw new SQLException("Ouve um erro ao se conectar com o MySql: " + error);
        }
    }
    ...
    public void closeConnection(Connection connection) {
        if (connection != null) {
            try {
                ...
                System.err.println("Erro ao fechar o pool com o banco de dados: " + error);
            }
        }
    }
}
